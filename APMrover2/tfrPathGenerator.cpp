...
void tfrPathGenerator::PathGen(float x_mea, float y_mea, float x_dot_mea, float y_dot_mea, float &spd_ref)
{
...
void tfrPathGenerator::GetSpdDem(float &spd_dem)
{
    spd_dem = fwd_speed_demand;
}
